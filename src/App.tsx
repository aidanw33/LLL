  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white">
      ...
      <nav className="flex items-center justify-between px-8 py-6 max-w-6xl mx-auto">
        ...
        <button className="rounded-lg bg-indigo-500 hover:bg-indigo-400 px-5 py-2 text-sm font-medium transition-colors">
          Sign in
        </button>
      </nav>
      ...
      <main className="flex flex-col items-center justify-center text-center px-6 pt-24 pb-32 max-w-3xl mx-auto">
        ...
        <div className="flex gap-4">
          <button className="rounded-lg bg-indigo-500 hover:bg-indigo-400 px-8 py-3 text-base font-medium transition-colors">
            Get started
          </button>
